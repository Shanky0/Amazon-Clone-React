                ...
                <div className='location'>
                    <a href='#0' style={{ color: 'white' }}>
                        <div style={{ display: 'flex' }}>
                            <div><img src={require('../images/location.jpeg')} style={{ height: '30px', marginTop: '10px', marginRight: "10px" }} alt='' /></div>
                            <div style={{ marginLeft: '2px' }}><span style={{ color: '#ddd', fontSize: 'medium' }}>Hello</span><br /><span style={{ fontSize: 'medium' }}>Enter your address</span></div>
                        </div>
                    </a>
                </div>
                <div className='srch'>
